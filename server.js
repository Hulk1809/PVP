...
// Ensure data directory exists on EC2 disk for persistent cloud state
...
// 2. API: Real-time Cloud State Sync (Stored persistently in data/tournament_state.json)
...
app.post('/api/sync', (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ success: true, lastUpdated: dataWithTimestamp.updatedAt });
  } catch (e) {
